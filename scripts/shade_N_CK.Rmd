...
write_tsv(pca.res.df, file="../results/PCA_loadings.txt") # Save loadings data
save(group, file = "../results/group.RData") # Save grouping data 
save(sampleLabels, file = "../results/sampleLabels.RData")  # Save sample labels data
